...
// 60 seconds (1 minute) * 180 = 3 hours
    ...
    public static final String PREFS_LOCATION_STATUS = "MyLocationStatus";
    ...
    public void setLocationStatus(Context c, @LocationStatus int locationStatus){
        ...
        spe.putInt("pref_location_status_key", locationStatus);
        spe.commit();
    }
...
//            final String FORECAST_BASE_URL = "http://api.openweathermap.org/data/2.5/forecast/daily?";
            final String FORECAST_BASE_URL = "http://ping?";
    ...
    private void getWeatherDataFromJson(String forecastJsonStr, String locationSetting)
        ...
        try {
            ...
            // add to database
            if (cVVector.size() > 0) {
                // Student: call bulkInsert to add the weatherEntries to the database herea
